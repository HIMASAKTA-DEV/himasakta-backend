...
type CabinetInfoRepository interface {
	...
	GetAll(ctx context.Context, tx *gorm.DB, metaReq meta.Meta, period string) ([]entity.CabinetInfo, meta.Meta, error)
...
func (r *cabinetInfoRepository) GetAll(ctx context.Context, tx *gorm.DB, metaReq meta.Meta, period string) ([]entity.CabinetInfo, meta.Meta, error) {
	if tx == nil {
		tx = r.db
	}
	if tx == nil {
