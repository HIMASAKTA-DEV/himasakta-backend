...
type Member struct {
	...
	RoleId       *uuid.UUID  `gorm:"type:uuid;index;constraint:OnDelete:SET NULL" json:"role_id"`
	Role         *Role       `gorm:"foreignKey:RoleId" json:"role"`
	DepartmentId *uuid.UUID  `gorm:"type:uuid;index;constraint:OnDelete:SET NULL" json:"department_id"`
	Department   *Department `gorm:"foreignKey:DepartmentId" json:"department"`
	PhotoId      *uuid.UUID  `gorm:"type:uuid;constraint:OnDelete:SET NULL" json:"photo_id"`
